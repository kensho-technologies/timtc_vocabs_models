...
class MPTBlock(nn.Module):
    ...
    def __init__(self, d_model: int, n_heads: int, expansion_ratio: int, attn_config: Optional[Dict]=None, ffn_config: Optional[Dict]=None, resid_pdrop: float=0.0, norm_type: str='low_precision_layernorm', verbose: int=0, fc_type: str='torch', device: Optional[str]=None, **kwargs: Any):
        ...
        self.attn = attn_class(d_model=d_model, n_heads=n_heads, fc_type=fc_type, verbose=verbose, device=device, **attn_config_subset_for_attn_class)
        self.norm_2 = None
